...
public class FileDataHandlerScript
{
    ...
    public void SaveData(GameDataScript _input)
    {
        ...
        //Path.Combine(_fileDirPath, _fileFileName);

        //string _fullPath = _fileDirPath + "/" + _fileFileName;

        //string _fullPath = Application.persistentDataPath + "/" + _fileDirPath;
    ...
    public GameDataScript LoadData()
    {
        ...
        //string _fullPath = Application.persistentDataPath + "/" + _fileFileName;
